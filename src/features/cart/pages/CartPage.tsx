    ...
    if (isLoading) {
        return (
            <div className="max-w-6xl mx-auto px-4 py-8">
                <div className="h-4 w-40 bg-gray-200 rounded animate-pulse mb-6"></div>
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        {[...Array(3)].map((_, i) => (
                            <div key={i} className="flex gap-4 p-4 bg-white rounded-xl border border-gray-200">
                                ...
                                <div className="h-5 w-16 bg-gray-200 rounded animate-pulse flex-shrink-0"></div>
                            </div>
                        ))}
                    </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 h-fit">
                    ...
                    <button onClick={() => navigate("/checkout")} className="w-full mt-6 py-3 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors font-medium">
                        Proceed to Checkout
                    </button>
